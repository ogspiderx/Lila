    ...
    >
      ...
      <div className="flex-1 overflow-hidden flex flex-col relative">
        ...
        >
          ...
          <div className="flex items-end gap-3 bg-gradient-to-r from-slate-800/90 to-slate-700/90 rounded-2xl p-4 border border-slate-600/50 shadow-xl backdrop-blur-sm transition-all hover:shadow-2xl hover:border-emerald-500/30"></div>
